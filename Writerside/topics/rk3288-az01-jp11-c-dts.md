...
/ {
	#address-cells = <0x02>;
	#size-cells = <0x02>;
	compatible = "inmusic,jp11", "inmusic,az01", "rockchip,rk3288-c", "rockchip,rk3288";
	...
	i2c@ff150000 {
		...
		battery@b {
			compatible = "ti,bq40z50", "sbs,sbs-battery";
			reg = <0x0b>;
			power-supplies = <0x35>;
	...
	sound {
		compatible = "inmusic,jp11-audio", "inmusic,jp11-audio";
	...
	sound-codec {
		compatible = "inmusic,jp11-audio-codec", "inmusic,jp11-audio-codec";
		#sound-dai-cells = <0x00>;
		clocks = <0x07 0x71>;
