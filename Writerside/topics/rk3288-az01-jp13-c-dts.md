...
/ {
	#address-cells = <0x02>;
	#size-cells = <0x02>;
	compatible = "inmusic,jp13", "inmusic,az01", "rockchip,rk3288-c", "rockchip,rk3288";
	...
	i2c@ff160000 {
		...
		ili2110@41 {
			compatible = "ilitek,ili2110", "ilitek,ili2116";
			status = "okay";
			reg = <0x41>;
			pinctrl-names = "default";
			pinctrl-0 = <0x38 0x39>;
		...
		ili2118@26 {
			compatible = "ilitek,ili2118", "ilitek,ili2117";
			status = "disabled";
			reg = <0x26 0x62>;
	...
	sound {
		compatible = "inmusic,jp13-audio", "inmusic,jp07-audio";
	...
	sound-codec {
		compatible = "inmusic,jp13-audio-codec", "inmusic,jp07-audio-codec";
		#sound-dai-cells = <0x00>;
		clocks = <0x07 0x71>;
