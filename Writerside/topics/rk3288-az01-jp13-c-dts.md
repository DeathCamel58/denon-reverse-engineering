...
/ {
	#address-cells = <0x02>;
	#size-cells = <0x02>;
	compatible = "inmusic,jp13\0inmusic,az01\0rockchip,rk3288-c\0rockchip,rk3288";
	interrupt-parent = <0x01>;
	inmusic,product-code = "JP13";
	inmusic,panel-rotation = <0x10e>;
	model = "Denon DJ SC6000 Prime";
	...
	i2c@ff140000 {
		...
		usb5537@2d {
			...
			smsc,config-file = [43 46 47 42 14 40 10 06 40 08 04 40 18 14 40 18 24 40 00 03 40 00 03 40 00 03 40 00 03 40 00 03 40 00 03 40 00 03 40 10 06 40 08 04 40 00 03 40 00 03 40 00 03 40 00 03 40 18 14 40 18 24 40 80 03 30 00 e4 15 0d e0 30 13 08 10 30 16 00 10 44 00 65 00 6e 00 6f 00 6e 00 20 00 44 00 4a 00 30 54 00 20 53 00 43 00 36 00 30 00 30 00 30 00 20 00 50 00 52 00 49 00 4d 00 45 00 20 00 48 00 75 00 62 00 3c 00 03 3c 04 03 3c 08 03 3c 0c 03 3c 10 03 3c 14 03 3c 18 03 50 48 e4 15 0d f0 50 4e 02 03 50 18 12 50 f4 12 50 1c 22 51 34 22 50 f6 00 10 44 00 65 00 6e 00 6f 00 6e 00 20 00 44 00 4a 00 51 36 00 20 53 00 43 00 36 00 30 00 30 00 30 00 20 00 50 00 52 00 49 00 4d 00 45 00 20 00 48 00 75 00 62 00 52 43 20];
			phandle = <0xa6>;
		};
	};
	...
	pinctrl {
		...
		i2s0 {
			...
			i2s0-bus {
				rockchip,pins = <0x06 0x00 0x01 0x91 0x06 0x01 0x01 0x91 0x06 0x02 0x01 0x91 0x06 0x03 0x01 0x91 0x06 0x04 0x01 0x91 0x06 0x05 0x01 0x91 0x06 0x08 0x01 0x92>;
				phandle = <0x70>;
			};
		};
		...
		sdmmc {
			...
			sdmmc-clk {
				rockchip,pins = <0x06 0x14 0x01 0x93>;
				phandle = <0x0e>;
			};

			sdmmc-cmd {
				rockchip,pins = <0x06 0x15 0x01 0x94>;
				phandle = <0x0f>;
			};

			sdmmc-cd {
				rockchip,pins = <0x06 0x16 0x01 0x94>;
			};

			sdmmc-bus1 {
				rockchip,pins = <0x06 0x10 0x01 0x94>;
			};

			sdmmc-bus4 {
				rockchip,pins = <0x06 0x10 0x01 0x94 0x06 0x11 0x01 0x94 0x06 0x12 0x01 0x94 0x06 0x13 0x01 0x94>;
				phandle = <0x10>;
			};
			...
			sdmmc-sel-ext {
				rockchip,pins = <0x02 0x06 0x00 0x95>;
				phandle = <0x14>;
			};
		...
		tsadc {
			...
			otp-pin {
				rockchip,pins = <0x00 0x0a 0x00 0x95>;
				phandle = <0x49>;
			};
		...
		gmac {
			...
			rgmii-pins {
				rockchip,pins = <0x03 0x1e 0x03 0x8d 0x03 0x1f 0x03 0x8d 0x03 0x1a 0x03 0x8d 0x03 0x1b 0x03 0x8d 0x03 0x1c 0x03 0x93 0x03 0x1d 0x03 0x93 0x03 0x18 0x03 0x93 0x03 0x19 0x03 0x93 0x04 0x00 0x03 0x8d 0x04 0x05 0x03 0x8d 0x04 0x06 0x03 0x8d 0x04 0x09 0x03 0x93 0x04 0x04 0x03 0x93 0x04 0x01 0x03 0x8d 0x04 0x03 0x03 0x8d>;
				phandle = <0x4f>;
			};
			...
			phy-rst {
				rockchip,pins = <0x04 0x08 0x00 0x95>;
				phandle = <0x51>;
			};
		};
		...
		usb-hub {
			...
			usb-sel-int {
				rockchip,pins = <0x08 0x01 0x00 0x95>;
				phandle = <0xa7>;
			};
		...
		sound-codec {
			...
			an-power-en {
				rockchip,pins = <0x02 0x01 0x00 0x8d>;
				phandle = <0xaf>;
			};

			codec-clksel {
				rockchip,pins = <0x06 0x06 0x00 0x8d 0x06 0x07 0x00 0x8d>;
				phandle = <0xac>;
			};

			codec-reset {
				rockchip,pins = <0x02 0x00 0x00 0x8d>;
				phandle = <0xae>;
			};

			mute {
				rockchip,pins = <0x02 0x02 0x00 0x8d>;
				phandle = <0xad>;
			};
		};
	};
	...
	sound {
		compatible = "inmusic,jp13-audio\0inmusic,jp07-audio";
	...
	sound-codec {
		compatible = "inmusic,jp13-audio-codec\0inmusic,jp07-audio-codec";
		#sound-dai-cells = <0x00>;
		clocks = <0x07 0x71>;
		enable-gpios = <0x7e 0x01 0x00>;
		mute-gpios = <0x7e 0x02 0x00>;
		reset-gpios = <0x7e 0x00 0x01>;
		pinctrl-0 = <0xad 0xae 0xaf>;
		pinctrl-names = "default";
		phandle = <0xab>;
	};
};
