...
/ {
	#address-cells = <0x02>;
	#size-cells = <0x02>;
	compatible = "inmusic,jc16\0inmusic,az01\0rockchip,rk3288-c\0rockchip,rk3288";
	interrupt-parent = <0x01>;
	inmusic,product-code = "JC16";
	inmusic,panel-rotation = <0x5a>;
	model = "Denon DJ Prime 2";
	...
	i2c@ff140000 {
		...
		usb5537@2d {
			...
			smsc,config-file = [43 46 47 42 15 40 10 06 40 08 04 40 18 14 40 18 1a 40 00 03 40 00 03 40 00 03 40 00 03 40 00 03 40 00 03 40 00 03 40 10 06 40 08 04 40 00 03 40 00 03 40 00 03 40 00 03 40 18 14 40 18 1a 40 80 03 40 80 03 30 00 e4 15 0b e0 30 13 08 0b 30 16 00 10 44 00 65 00 6e 00 6f 00 6e 00 20 00 44 00 4a 00 30 54 00 16 50 00 52 00 49 00 4d 00 45 00 20 00 32 00 20 00 48 00 75 00 62 00 3c 00 03 3c 04 03 3c 08 03 3c 0c 03 3c 10 03 3c 14 03 3c 18 03 50 48 e4 15 0b f0 50 4e 02 03 50 18 12 50 f4 12 50 1c 18 51 34 18 50 f6 00 10 44 00 65 00 6e 00 6f 00 6e 00 20 00 44 00 4a 00 51 36 00 16 50 00 52 00 49 00 4d 00 45 00 20 00 32 00 20 00 48 00 75 00 62 00 52 43 20 09 51 01];
			phandle = <0xb3>;
		};
	};
	...
	pinctrl {
		...
		sound-codec {
			...
			codec-clksel {
				rockchip,pins = <0x02 0x03 0x00 0x9a 0x02 0x04 0x00 0x9a>;
				phandle = <0xba>;
			};
	...
	cpu-fan {
		...
		#cooling-cells = <0x02>;
		pwms = <0xb7 0x00 0x9c40 0x00>;
		cooling-levels = <0x00 0x4d 0x5f 0x6d 0x7d 0x9d 0xff>;
		phandle = <0x4a>;
	};

	sound {
		compatible = "inmusic,jc16-audio\0inmusic,jc16-audio";
		clksel0-gpios = <0x8b 0x03 0x00>;
		clksel1-gpios = <0x8b 0x04 0x00>;
		inmusic,cpu = <0xb8>;
		inmusic,codec = <0xb9>;
		pinctrl-0 = <0xba>;
		pinctrl-names = "default";
	...
	sound-codec {
		compatible = "inmusic,jc16-audio-codec\0inmusic,jc16-audio-codec";
		#sound-dai-cells = <0x00>;
		clocks = <0x07 0x71>;
