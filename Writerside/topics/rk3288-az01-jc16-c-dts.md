...
/ {
	#address-cells = <0x02>;
	#size-cells = <0x02>;
	compatible = "inmusic,jc16", "inmusic,az01", "rockchip,rk3288-c", "rockchip,rk3288";
	...
	sound {
		compatible = "inmusic,jc16-audio", "inmusic,jc16-audio";
	...
	sound-codec {
		compatible = "inmusic,jc16-audio-codec", "inmusic,jc16-audio-codec";
		#sound-dai-cells = <0x00>;
		clocks = <0x07 0x71>;
