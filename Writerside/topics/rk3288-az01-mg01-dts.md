...
/ {
	#address-cells = <0x02>;
	#size-cells = <0x02>;
	compatible = "inmusic,mg01\0inmusic,az01\0rockchip,rk3288";
	interrupt-parent = <0x01>;
	inmusic,product-code = "MG01";
	...
	i2c@ff140000 {
		...
		usb5537@2d {
			...
			smsc,config-file = [43 46 47 42 14 40 10 06 40 08 04 40 18 0a 40 18 18 40 00 03 40 00 03 40 00 03 40 00 03 40 00 03 40 00 03 40 00 03 40 10 06 40 08 04 40 00 03 40 00 03 40 00 03 40 00 03 40 18 0a 40 18 18 40 80 03 30 00 63 07 16 50 30 13 03 0a 30 16 00 06 41 00 49 00 52 00 30 54 00 14 45 00 6c 00 65 00 76 00 65 00 6e 00 20 00 48 00 75 00 62 00 3c 00 03 3c 04 03 3c 08 03 3c 0c 03 3c 10 03 3c 14 03 3c 18 03 50 48 63 07 16 60 50 4e 02 03 50 18 08 50 f4 08 50 1c 16 51 34 16 50 f6 00 06 41 00 49 00 52 00 51 36 00 14 45 00 6c 00 65 00 76 00 65 00 6e 00 20 00 48 00 75 00 62 00 52 43 20];
			phandle = <0xa4>;
		};
	};
	...
	pinctrl {
		...
		i2s0 {
			...
			i2s0-bus {
				rockchip,pins = <0x06 0x00 0x01 0x8f 0x06 0x01 0x01 0x8f 0x06 0x02 0x01 0x8f 0x06 0x03 0x01 0x8f 0x06 0x04 0x01 0x8f 0x06 0x05 0x01 0x8f 0x06 0x06 0x01 0x8f 0x06 0x07 0x01 0x8f>;
				phandle = <0x6f>;
			};

			i2s0-mclk {
				rockchip,pins = <0x06 0x08 0x01 0x90>;
				phandle = <0xad>;
			};
		};
		...
		sdmmc {
			...
			sdmmc-int-cd-gpio {
				rockchip,pins = <0x02 0x05 0x00 0x8d>;
				phandle = <0x12>;
			};

			sdmmc-ext-cd-gpio {
				rockchip,pins = <0x04 0x1b 0x00 0x8d>;
				phandle = <0x11>;
			};
			...
			sdmmc-sel-int {
				rockchip,pins = <0x02 0x06 0x00 0x8c>;
				phandle = <0x14>;
			};
			...
			sdmmc-gpios {
				rockchip,pins = <0x06 0x10 0x00 0x8c 0x06 0x11 0x00 0x8c 0x06 0x12 0x00 0x8c 0x06 0x13 0x00 0x8c 0x06 0x14 0x00 0x8c 0x06 0x15 0x00 0x8c>;
				phandle = <0x15>;
			};
		};
		...
		gmac {
			...
			rgmii-pins {
				rockchip,pins = <0x03 0x1e 0x03 0x8b 0x03 0x1f 0x03 0x8b 0x03 0x1a 0x03 0x8b 0x03 0x1b 0x03 0x8b 0x03 0x1c 0x03 0x91 0x03 0x1d 0x03 0x91 0x03 0x18 0x03 0x91 0x03 0x19 0x03 0x91 0x04 0x00 0x03 0x8b 0x04 0x05 0x03 0x8b 0x04 0x06 0x03 0x8b 0x04 0x09 0x03 0x91 0x04 0x04 0x03 0x91 0x04 0x01 0x03 0x8b 0x04 0x03 0x03 0x8b>;
				phandle = <0x4e>;
			};
		...
		reboot {
			...
			pwr-off-delay {
				rockchip,pins = <0x00 0x09 0x00 0x8b>;
				phandle = <0x98>;
			};
		};
		...
		leds {
			...
			led2 {
				rockchip,pins = <0x00 0x0b 0x00 0x8b>;
				phandle = <0x9a>;
			};
		...
		mipi_panel {
			...
			mipi-reset {
				rockchip,pins = <0x02 0x07 0x00 0x8b>;
				phandle = <0x7b>;
			};

			lcd-cs {
				rockchip,pins = <0x07 0x04 0x00 0x8b>;
				phandle = <0x9e>;
			};
		};
		...
		pmic {
			...
			pmic-int {
				rockchip,pins = <0x00 0x04 0x00 0x8d>;
				phandle = <0x59>;
			};
		};
		...
		sata {
			...
			sata-pwr {
				rockchip,pins = <0x00 0x0d 0x00 0x8b>;
				phandle = <0x9f>;
			};

			sata-reset {
				rockchip,pins = <0x07 0x15 0x00 0x8b>;
			};
		};
		...
		usb_host {
			...
			host-vbus-drv {
				rockchip,pins = <0x00 0x0e 0x00 0x8b>;
				phandle = <0xa1>;
			};
		};
		...
		usb_otg {
			...
			otg-vbus-drv {
				rockchip,pins = <0x00 0x0c 0x00 0x8b>;
				phandle = <0xa2>;
			};
		};
		...
		usb-hub {
			...
			usb-mux-sel {
				rockchip,pins = <0x08 0x01 0x00 0x8b>;
			};
		...
		sound-codec {
			...
			codec-clksel {
				rockchip,pins = <0x06 0x0b 0x00 0x8b 0x06 0x08 0x00 0x8b>;
				phandle = <0xac>;
			};
	...
	sound {
		compatible = "inmusic,mg01-audio";
		clksel0-gpios = <0xa8 0x0b 0x00>;
		clksel1-gpios = <0xa8 0x08 0x00>;
		inmusic,cpu = <0xa9>;
		inmusic,codec = <0xaa>;
		inmusic,master-slave-gpios = <0xa8 0x0b 0x01>;
		pinctrl-0 = <0xab>;
		pinctrl-1 = <0xac>;
		pinctrl-2 = <0xad>;
		pinctrl-names = "default\0codec-clk-master\0codec-clk-slave";
	};

	sound-codec {
		compatible = "inmusic,mg01-audio-codec";
		#sound-dai-cells = <0x00>;
		clocks = <0x07 0x71>;
