...
/ {
	#address-cells = <0x02>;
	#size-cells = <0x02>;
	compatible = "inmusic,acv5s\0inmusic,az01\0rockchip,rk3288";
	interrupt-parent = <0x01>;
	model = "Akai Professional MPC X SE";
	inmusic,product-code = "ACV5S";
	...
	i2c@ff140000 {
		...
		usb5537@2d {
			...
			smsc,config-file = [43 46 47 42 14 40 10 06 40 08 04 40 18 26 40 18 1c 40 00 03 40 00 03 40 00 03 40 00 03 40 00 03 40 00 03 40 00 03 40 10 06 40 08 04 40 00 03 40 00 03 40 00 03 40 00 03 40 18 26 40 18 1c 40 80 03 30 00 e8 09 52 50 30 13 11 0c 30 16 00 22 41 00 6b 00 61 00 69 00 20 00 50 00 72 00 6f 00 66 00 65 00 73 00 73 00 69 00 6f 00 6e 00 61 00 6c 00 30 54 00 18 4d 00 50 00 43 00 20 00 58 00 20 00 53 00 45 00 20 00 48 00 75 00 62 00 3c 00 03 3c 04 03 3c 08 03 3c 0c 03 3c 10 03 3c 14 03 3c 18 03 50 48 e8 09 52 60 50 4e 02 03 50 18 24 50 f4 24 50 1c 1a 51 34 1a 50 f6 00 22 41 00 6b 00 61 00 69 00 20 00 50 00 72 00 6f 00 66 00 65 00 73 00 73 00 69 00 6f 00 6e 00 61 00 6c 00 51 36 00 18 4d 00 50 00 43 00 20 00 58 00 20 00 53 00 45 00 20 00 48 00 75 00 62 00 52 43 20];
			smsc,ss-disable-mask = <0x0e>;
			phandle = <0xa4>;
		};
	};
	...
	i2c@ff160000 {
		...
		ili2110@41 {
			compatible = "ilitek,ili2110\0ilitek,ili2116";
			status = "okay";
			reg = <0x41>;
			pinctrl-names = "default";
			pinctrl-0 = <0x37 0x38>;
			...
			irq-gpios = <0x33 0x06 0x00>;
			reset-gpios = <0x33 0x05 0x00>;
		};

		ili2118@26 {
			compatible = "ilitek,ili2118\0ilitek,ili2117";
			status = "disabled";
			reg = <0x26 0x62>;
	...
	serial@ff180000 {
		...
		bluetooth {
			...
			device-wakeup-gpios = <0x1f 0x1a 0x00>;
			shutdown-gpios = <0x1f 0x1d 0x00>;
		};
	};
	...
	power-management@ff730000 {
		...
		power-controller {
			...
			power-domain@9 {
				...
				pm_qos = <0x5f 0x60 0x61 0x62 0x63 0x64 0x65 0x66 0x67>;
	...
	pinctrl {
		...
		hdmi {
			...
			hdmi-cec-c0 {
				rockchip,pins = <0x07 0x10 0x02 0x8c>;
			};

			hdmi-cec-c7 {
				rockchip,pins = <0x07 0x17 0x04 0x8c>;
			};

			hdmi-ddc {
				rockchip,pins = <0x07 0x13 0x02 0x8c 0x07 0x14 0x02 0x8c>;
			};

			hdmi-ddc-unwedge {
				rockchip,pins = <0x07 0x13 0x00 0x8d 0x07 0x14 0x02 0x8c>;
			};
		};
		...
		suspend {
			...
			global-pwroff {
				rockchip,pins = <0x00 0x00 0x01 0x8c>;
			};

			ddrio-pwroff {
				rockchip,pins = <0x00 0x01 0x01 0x8c>;
			};

			ddr0-retention {
				rockchip,pins = <0x00 0x02 0x01 0x8e>;
			};

			ddr1-retention {
				rockchip,pins = <0x00 0x03 0x01 0x8e>;
			};
		};
		...
		edp {
			...
			edp-hpd {
				rockchip,pins = <0x07 0x0b 0x02 0x8f>;
			};
		};
		...
		i2c0 {
			...
			i2c0-xfer {
				rockchip,pins = <0x00 0x0f 0x01 0x8c 0x00 0x10 0x01 0x8c>;
				phandle = <0x55>;
			};
		};
		...
		i2c1 {
			...
			i2c1-xfer {
				rockchip,pins = <0x08 0x04 0x01 0x8c 0x08 0x05 0x01 0x8c>;
				phandle = <0x32>;
			};
		};
		...
		i2c2 {
			...
			i2c2-xfer {
				rockchip,pins = <0x06 0x09 0x01 0x8c 0x06 0x0a 0x01 0x8c>;
				phandle = <0x5a>;
			};
		};
		...
		i2c3 {
			...
			i2c3-xfer {
				rockchip,pins = <0x02 0x10 0x01 0x8c 0x02 0x11 0x01 0x8c>;
				phandle = <0x35>;
			};
		};
		...
		i2c4 {
			...
			i2c4-xfer {
				rockchip,pins = <0x07 0x11 0x01 0x8c 0x07 0x12 0x01 0x8c>;
				phandle = <0x36>;
			};
		};
		...
		i2c5 {
			...
			i2c5-xfer {
				rockchip,pins = <0x07 0x13 0x01 0x8c 0x07 0x14 0x01 0x8c>;
				phandle = <0x39>;
			};
		};
		...
		i2s0 {
			...
			i2s0-bus {
				rockchip,pins = <0x06 0x00 0x01 0x8c 0x06 0x01 0x01 0x8c 0x06 0x02 0x01 0x8c 0x06 0x03 0x01 0x8c 0x06 0x04 0x01 0x8c 0x06 0x05 0x01 0x8c 0x06 0x06 0x01 0x8c 0x06 0x07 0x01 0x8c 0x06 0x08 0x01 0x8c>;
				phandle = <0x6f>;
			};
		};
		...
		lcdc {
			...
			lcdc-ctl {
				rockchip,pins = <0x01 0x18 0x01 0x8c 0x01 0x19 0x01 0x8c 0x01 0x1a 0x01 0x8c 0x01 0x1b 0x01 0x8c>;
				phandle = <0x80>;
			};
		};
		...
		sdmmc {
			...
			sdmmc-clk {
				rockchip,pins = <0x06 0x14 0x01 0x90>;
				phandle = <0x0e>;
			};

			sdmmc-cmd {
				rockchip,pins = <0x06 0x15 0x01 0x91>;
				phandle = <0x0f>;
			};

			sdmmc-cd {
				rockchip,pins = <0x06 0x16 0x01 0x91>;
			};

			sdmmc-bus1 {
				rockchip,pins = <0x06 0x10 0x01 0x91>;
			};

			sdmmc-bus4 {
				rockchip,pins = <0x06 0x10 0x01 0x91 0x06 0x11 0x01 0x91 0x06 0x12 0x01 0x91 0x06 0x13 0x01 0x91>;
				phandle = <0x10>;
			};

			sdmmc-int-cd-gpio {
				rockchip,pins = <0x02 0x05 0x00 0x8e>;
				phandle = <0x12>;
			};

			sdmmc-ext-cd-gpio {
				rockchip,pins = <0x04 0x1b 0x00 0x8e>;
				phandle = <0x11>;
			};

			sdmmc-wp-gpio {
				rockchip,pins = <0x06 0x16 0x00 0x8e>;
				phandle = <0x13>;
			};

			sdmmc-sel-ext {
				rockchip,pins = <0x02 0x06 0x00 0x92>;
			};

			sdmmc-sel-int {
				rockchip,pins = <0x02 0x06 0x00 0x8d>;
				phandle = <0x14>;
			};

			sdmmc-pwr {
				rockchip,pins = <0x07 0x0b 0x00 0x8c>;
				phandle = <0xa0>;
			};

			sdmmc-gpios {
				rockchip,pins = <0x06 0x10 0x00 0x8d 0x06 0x11 0x00 0x8d 0x06 0x12 0x00 0x8d 0x06 0x13 0x00 0x8d 0x06 0x14 0x00 0x8d 0x06 0x15 0x00 0x8d>;
				phandle = <0x15>;
			};
		};
		...
		sdio0 {
			...
			sdio0-bus4 {
				rockchip,pins = <0x04 0x14 0x01 0x8e 0x04 0x15 0x01 0x8e 0x04 0x16 0x01 0x8e 0x04 0x17 0x01 0x8e>;
				phandle = <0x19>;
			};

			sdio0-cmd {
				rockchip,pins = <0x04 0x18 0x01 0x8e>;
				phandle = <0x1a>;
			};

			sdio0-clk {
				rockchip,pins = <0x04 0x19 0x01 0x8c>;
				phandle = <0x1b>;
			};

			sdio0-cd {
				rockchip,pins = <0x04 0x1a 0x01 0x8e>;
			};

			sdio0-wp {
				rockchip,pins = <0x04 0x1b 0x01 0x8e>;
			};

			sdio0-pwr {
				rockchip,pins = <0x04 0x1c 0x01 0x8e>;
			};

			sdio0-bkpwr {
				rockchip,pins = <0x04 0x1d 0x01 0x8e>;
			};

			sdio0-int {
				rockchip,pins = <0x04 0x1e 0x01 0x8e>;
				phandle = <0x1c>;
			};
		};
		...
		sdio1 {
			...
			sdio1-bus1 {
				rockchip,pins = <0x03 0x18 0x04 0x8e>;
			};

			sdio1-bus4 {
				rockchip,pins = <0x03 0x18 0x04 0x8e 0x03 0x19 0x04 0x8e 0x03 0x1a 0x04 0x8e 0x03 0x1b 0x04 0x8e>;
			};

			sdio1-cd {
				rockchip,pins = <0x03 0x1c 0x04 0x8e>;
			};

			sdio1-wp {
				rockchip,pins = <0x03 0x1d 0x04 0x8e>;
			};

			sdio1-bkpwr {
				rockchip,pins = <0x03 0x1e 0x04 0x8e>;
			};

			sdio1-int {
				rockchip,pins = <0x03 0x1f 0x04 0x8e>;
			};

			sdio1-cmd {
				rockchip,pins = <0x04 0x06 0x04 0x8e>;
			};

			sdio1-clk {
				rockchip,pins = <0x04 0x07 0x04 0x8c>;
			};

			sdio1-pwr {
				rockchip,pins = <0x04 0x09 0x04 0x8e>;
			};
		};
		...
		emmc {
			...
			emmc-cmd {
				rockchip,pins = <0x03 0x10 0x02 0x8e>;
				phandle = <0x22>;
			};

			emmc-pwr {
				rockchip,pins = <0x03 0x09 0x02 0x8e>;
			};

			emmc-bus1 {
				rockchip,pins = <0x03 0x00 0x02 0x8e>;
			};

			emmc-bus4 {
				rockchip,pins = <0x03 0x00 0x02 0x8e 0x03 0x01 0x02 0x8e 0x03 0x02 0x02 0x8e 0x03 0x03 0x02 0x8e>;
			};

			emmc-bus8 {
				rockchip,pins = <0x03 0x00 0x02 0x8e 0x03 0x01 0x02 0x8e 0x03 0x02 0x02 0x8e 0x03 0x03 0x02 0x8e 0x03 0x04 0x02 0x8e 0x03 0x05 0x02 0x8e 0x03 0x06 0x02 0x8e 0x03 0x07 0x02 0x8e>;
				phandle = <0x23>;
			};

			emmc-reset {
				rockchip,pins = <0x03 0x09 0x00 0x8c>;
				phandle = <0x95>;
			};
		};
		...
		spi0 {
			...
			spi0-clk {
				rockchip,pins = <0x05 0x0c 0x01 0x8e>;
				phandle = <0x26>;
			};

			spi0-cs0 {
				rockchip,pins = <0x05 0x0d 0x01 0x8e>;
				phandle = <0x29>;
			};

			spi0-tx {
				rockchip,pins = <0x05 0x0e 0x01 0x8e>;
				phandle = <0x27>;
			};

			spi0-rx {
				rockchip,pins = <0x05 0x0f 0x01 0x8e>;
				phandle = <0x28>;
			};

			spi0-cs1 {
				rockchip,pins = <0x05 0x10 0x01 0x8e>;
			};
		};
		...
		spi1 {
			...
			spi1-clk {
				rockchip,pins = <0x07 0x0c 0x02 0x8e>;
				phandle = <0x2a>;
			};

			spi1-cs0 {
				rockchip,pins = <0x07 0x0d 0x02 0x8e>;
				phandle = <0x2d>;
			};

			spi1-rx {
				rockchip,pins = <0x07 0x0e 0x02 0x8e>;
				phandle = <0x2c>;
			};

			spi1-tx {
				rockchip,pins = <0x07 0x0f 0x02 0x8e>;
				phandle = <0x2b>;
			};
		};
		...
		spi2 {
			...
			spi2-cs1 {
				rockchip,pins = <0x08 0x03 0x01 0x8e>;
			};

			spi2-clk {
				rockchip,pins = <0x08 0x06 0x01 0x8e>;
				phandle = <0x2e>;
			};

			spi2-cs0 {
				rockchip,pins = <0x08 0x07 0x01 0x8e>;
				phandle = <0x31>;
			};

			spi2-rx {
				rockchip,pins = <0x08 0x08 0x01 0x8e>;
				phandle = <0x30>;
			};

			spi2-tx {
				rockchip,pins = <0x08 0x09 0x01 0x8e>;
				phandle = <0x2f>;
			};
		};
		...
		uart0 {
			...
			uart0-xfer {
				rockchip,pins = <0x04 0x10 0x01 0x8e 0x04 0x11 0x01 0x8c>;
				phandle = <0x3a>;
			};
			...
			uart0-rts {
				rockchip,pins = <0x04 0x13 0x01 0x8c>;
				phandle = <0x3c>;
			};
		};
		...
		uart1 {
			...
			uart1-xfer {
				rockchip,pins = <0x05 0x08 0x01 0x8e 0x05 0x09 0x01 0x8c>;
				phandle = <0x41>;
			};

			uart1-cts {
				rockchip,pins = <0x05 0x0a 0x01 0x8e>;
				phandle = <0x42>;
			};

			uart1-rts {
				rockchip,pins = <0x05 0x0b 0x01 0x8c>;
				phandle = <0x43>;
			};
		};
		...
		uart2 {
			...
			uart2-xfer {
				rockchip,pins = <0x07 0x16 0x01 0x8e 0x07 0x17 0x01 0x8c>;
				phandle = <0x44>;
			};
		};
		...
		uart3 {
			...
			uart3-xfer {
				rockchip,pins = <0x07 0x07 0x01 0x8e 0x07 0x08 0x01 0x8c>;
				phandle = <0x45>;
			};

			uart3-cts {
				rockchip,pins = <0x07 0x09 0x01 0x8e>;
			};

			uart3-rts {
				rockchip,pins = <0x07 0x0a 0x01 0x8c>;
			};
		};
		...
		uart4 {
			...
			uart4-xfer {
				rockchip,pins = <0x05 0x0f 0x03 0x8e 0x05 0x0e 0x03 0x8c>;
				phandle = <0x46>;
			};

			uart4-cts {
				rockchip,pins = <0x05 0x0c 0x03 0x8e>;
			};

			uart4-rts {
				rockchip,pins = <0x05 0x0d 0x03 0x8c>;
			};
		};
		...
		tsadc {
			...
			otp-pin {
				rockchip,pins = <0x00 0x0a 0x00 0x92>;
				phandle = <0x48>;
			};

			otp-out {
				rockchip,pins = <0x00 0x0a 0x01 0x8c>;
				phandle = <0x49>;
			};
		};
		...
		pwm0 {
			...
			pwm0-pin {
				rockchip,pins = <0x07 0x00 0x01 0x8c>;
				phandle = <0x5b>;
			};
		};
		...
		pwm1 {
			...
			pwm1-pin {
				rockchip,pins = <0x07 0x01 0x01 0x8c>;
				phandle = <0x5c>;
			};
		};
		...
		pwm2 {
			...
			pwm2-pin {
				rockchip,pins = <0x07 0x16 0x03 0x8c>;
				phandle = <0x5d>;
			};
		};
		...
		pwm3 {
			...
			pwm3-pin {
				rockchip,pins = <0x07 0x17 0x03 0x8c>;
				phandle = <0x5e>;
			};
		};
		...
		gmac {
			...
			rgmii-pins {
				rockchip,pins = <0x03 0x1e 0x03 0x8c 0x03 0x1f 0x03 0x8c 0x03 0x1a 0x03 0x8c 0x03 0x1b 0x03 0x8c 0x03 0x1c 0x03 0x93 0x03 0x1d 0x03 0x93 0x03 0x18 0x03 0x93 0x03 0x19 0x03 0x93 0x04 0x00 0x03 0x8c 0x04 0x05 0x03 0x8c 0x04 0x06 0x03 0x8c 0x04 0x09 0x03 0x93 0x04 0x04 0x03 0x93 0x04 0x01 0x03 0x8c 0x04 0x03 0x03 0x8c>;
				phandle = <0x4e>;
			};

			rmii-pins {
				rockchip,pins = <0x03 0x1e 0x03 0x8c 0x03 0x1f 0x03 0x8c 0x03 0x1c 0x03 0x8c 0x03 0x1d 0x03 0x8c 0x04 0x00 0x03 0x8c 0x04 0x05 0x03 0x8c 0x04 0x04 0x03 0x8c 0x04 0x01 0x03 0x8c 0x04 0x02 0x03 0x8c 0x04 0x03 0x03 0x8c>;
			};

			phy-int {
				rockchip,pins = <0x03 0x0f 0x00 0x8e>;
				phandle = <0x4f>;
			};

			phy-rst {
				rockchip,pins = <0x04 0x08 0x00 0x92>;
				phandle = <0x50>;
			};
		};
		...
		spdif {
			...
			spdif-tx {
				rockchip,pins = <0x06 0x0b 0x01 0x8c>;
				phandle = <0x6e>;
			};
		};
		...
		az01 {
			...
			az01-pcb-rev {
				rockchip,pins = <0x02 0x08 0x00 0x8e 0x02 0x0b 0x00 0x8e 0x02 0x0d 0x00 0x8e 0x02 0x0e 0x00 0x8e>;
				phandle = <0x8b>;
			};
		};
		...
		reboot {
			...
			pwr-off-delay {
				rockchip,pins = <0x00 0x09 0x00 0x8c>;
				phandle = <0x98>;
			};
		};
		...
		bluetooth {
			...
			bt-wake {
				rockchip,pins = <0x04 0x1a 0x00 0x8c>;
				phandle = <0x3f>;
			};

			bt-reg-on {
				rockchip,pins = <0x04 0x1d 0x00 0x8c>;
				phandle = <0x3e>;
			};

			bt-host-wake {
				rockchip,pins = <0x04 0x1f 0x00 0x8e>;
				phandle = <0x40>;
			};
		};
		...
		leds {
			...
			led1 {
				rockchip,pins = <0x07 0x0f 0x00 0x8c>;
				phandle = <0x99>;
			};

			led2 {
				rockchip,pins = <0x00 0x0b 0x00 0x8c>;
				phandle = <0x9a>;
			};
		...
		sdio {
			...
			wifi-enable {
				rockchip,pins = <0x04 0x1c 0x00 0x8c>;
				phandle = <0x9d>;
			};
		};
		...
		vcc_lcd {
			...
			lcd-en {
				rockchip,pins = <0x07 0x03 0x00 0x8c>;
			};
		};
		...
		mipi_panel {
			...
			mipi-reset {
				rockchip,pins = <0x02 0x07 0x00 0x8c>;
				phandle = <0x7b>;
			};

			lcd-cs {
				rockchip,pins = <0x07 0x04 0x00 0x8c>;
				phandle = <0x9e>;
			};
		};
		...
		pmic {
			...
			pmic-int {
				rockchip,pins = <0x00 0x04 0x00 0x8e>;
				phandle = <0x59>;
			};
		};
		...
		sata {
			...
			sata-pwr {
				rockchip,pins = <0x00 0x0d 0x00 0x8c>;
				phandle = <0x9f>;
			};

			sata-reset {
				rockchip,pins = <0x07 0x15 0x00 0x8c>;
			};
		};
		...
		touch {
			...
			touch-int {
				rockchip,pins = <0x07 0x06 0x00 0x8e>;
				phandle = <0x37>;
			};

			touch-rst {
				rockchip,pins = <0x07 0x05 0x00 0x8c>;
				phandle = <0x38>;
			};
		};
		...
		usb_host {
			...
			host-vbus-drv {
				rockchip,pins = <0x00 0x0e 0x00 0x8c>;
				phandle = <0xa1>;
			};
		};
		...
		usb_otg {
			...
			otg-vbus-drv {
				rockchip,pins = <0x00 0x0c 0x00 0x8c>;
				phandle = <0xa2>;
			};
		};
		...
		usb-hub {
			...
			usb-reset-pin {
				rockchip,pins = <0x07 0x02 0x00 0x94>;
				phandle = <0x34>;
			};

			usb-mux-sel {
				rockchip,pins = <0x08 0x01 0x00 0x8c>;
			};

			usb-sel-int {
				rockchip,pins = <0x08 0x01 0x00 0x92>;
				phandle = <0xa5>;
			};

			usb-sel-ext {
				rockchip,pins = <0x08 0x01 0x00 0x8d>;
				phandle = <0xa7>;
			};
		};
	};
	...
	chosen {
		...
		inmusic,internal-sd-fitted;
		inmusic,acvs-emmc-synths;
	};

	ac-power {
		compatible = "inmusic,az01-power";
		io-channels = <0x96 0x00>;
	};
	...
	mipi-backlight {
		...
		default-brightness-level = <0xb7>;
		power-supply = <0x56>;
		pwms = <0x9b 0x00 0x9c40 0x00>;
		phandle = <0x7e>;
	};
