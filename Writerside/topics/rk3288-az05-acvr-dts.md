...
/ {
	#address-cells = <0x02>;
	#size-cells = <0x02>;
	compatible = "inmusic,acvr\0inmusic,az05\0rockchip,rk3288";
	interrupt-parent = <0x01>;
	model = "Akai Professional MPC Key 37";
	inmusic,product-code = "ACVR";
	...
	sound {
		compatible = "inmusic,acvr-audio";
		inmusic,cpu = <0x96>;
		inmusic,codec = <0x97>;
	};

	sound-codec {
		compatible = "inmusic,acvr-audio-codec";
		#sound-dai-cells = <0x00>;
		clocks = <0x07 0x71>;
