...
/ {
	#address-cells = <0x02>;
	#size-cells = <0x02>;
	compatible = "inmusic,acvm\0inmusic,az01\0rockchip,rk3288-c\0rockchip,rk3288";
	interrupt-parent = <0x01>;
	inmusic,product-code = "ACVM";
	inmusic,panel-rotation = <0x10e>;
	model = "Akai Professional MPC Key 61";
	...
	i2c@ff140000 {
		...
		usb5537@2d {
			...
			smsc,config-file = [43 46 47 42 14 40 10 06 40 08 04 40 18 26 40 18 20 40 00 03 40 00 03 40 00 03 40 00 03 40 00 03 40 00 03 40 00 03 40 10 06 40 08 04 40 00 03 40 00 03 40 00 03 40 00 03 40 18 26 40 18 20 40 80 03 30 00 e8 09 4b 50 30 13 11 0e 30 16 00 22 41 00 6b 00 61 00 69 00 20 00 50 00 72 00 6f 00 66 00 65 00 73 00 73 00 69 00 6f 00 6e 00 61 00 6c 00 30 54 00 1c 4d 00 50 00 43 00 20 00 4b 00 65 00 79 00 20 00 36 00 31 00 20 00 48 00 75 00 62 00 3c 00 03 3c 04 03 3c 08 03 3c 0c 03 3c 10 03 3c 14 03 3c 18 03 50 48 e8 09 4b 60 50 4e 02 03 50 18 24 50 f4 24 50 1c 1e 51 34 1e 50 f6 00 22 41 00 6b 00 61 00 69 00 20 00 50 00 72 00 6f 00 66 00 65 00 73 00 73 00 69 00 6f 00 6e 00 61 00 6c 00 51 36 00 1c 4d 00 50 00 43 00 20 00 4b 00 65 00 79 00 20 00 36 00 31 00 20 00 48 00 75 00 62 00 52 43 20];
	...
	serial@ff180000 {
		...
		bluetooth {
			...
			device-wakeup-gpios = <0x20 0x1a 0x00>;
			shutdown-gpios = <0x20 0x1d 0x00>;
		};
	};
	...
	pinctrl {
		...
		i2s0 {
			...
			i2s0-bus {
				rockchip,pins = <0x06 0x00 0x01 0x90 0x06 0x01 0x01 0x90 0x06 0x02 0x01 0x90 0x06 0x03 0x01 0x90 0x06 0x04 0x01 0x90 0x06 0x05 0x01 0x90 0x06 0x06 0x01 0x90 0x06 0x07 0x01 0x90 0x06 0x08 0x01 0x91>;
				phandle = <0x70>;
			};
		};
		...
		sdmmc {
			...
			sdmmc-clk {
				rockchip,pins = <0x06 0x14 0x01 0x92>;
				phandle = <0x0e>;
			};

			sdmmc-cmd {
				rockchip,pins = <0x06 0x15 0x01 0x93>;
				phandle = <0x0f>;
			};

			sdmmc-cd {
				rockchip,pins = <0x06 0x16 0x01 0x93>;
			};

			sdmmc-bus1 {
				rockchip,pins = <0x06 0x10 0x01 0x93>;
			};

			sdmmc-bus4 {
				rockchip,pins = <0x06 0x10 0x01 0x93 0x06 0x11 0x01 0x93 0x06 0x12 0x01 0x93 0x06 0x13 0x01 0x93>;
				phandle = <0x10>;
			};
			...
			sdmmc-sel-ext {
				rockchip,pins = <0x02 0x06 0x00 0x94>;
			};
		...
		tsadc {
			...
			otp-pin {
				rockchip,pins = <0x00 0x0a 0x00 0x94>;
				phandle = <0x49>;
			};
		...
		gmac {
			...
			rgmii-pins {
				rockchip,pins = <0x03 0x1e 0x03 0x8c 0x03 0x1f 0x03 0x8c 0x03 0x1a 0x03 0x8c 0x03 0x1b 0x03 0x8c 0x03 0x1c 0x03 0x92 0x03 0x1d 0x03 0x92 0x03 0x18 0x03 0x92 0x03 0x19 0x03 0x92 0x04 0x00 0x03 0x8c 0x04 0x05 0x03 0x8c 0x04 0x06 0x03 0x8c 0x04 0x09 0x03 0x92 0x04 0x04 0x03 0x92 0x04 0x01 0x03 0x8c 0x04 0x03 0x03 0x8c>;
				phandle = <0x4f>;
			};
			...
			phy-rst {
				rockchip,pins = <0x04 0x08 0x00 0x94>;
				phandle = <0x51>;
			};
		};
		...
		usb-hub {
			...
			usb-sel-int {
				rockchip,pins = <0x08 0x01 0x00 0x94>;
				phandle = <0xa6>;
			};
		...
		sound-codec {
			...
			an-power-en {
				rockchip,pins = <0x02 0x01 0x00 0x8c>;
				phandle = <0xad>;
			};

			codec-reset {
				rockchip,pins = <0x02 0x00 0x00 0x8c>;
				phandle = <0xac>;
			};

			mute {
				rockchip,pins = <0x02 0x02 0x00 0x8c>;
				phandle = <0xab>;
			};
		};
	};
	...
	sound {
		compatible = "inmusic,acvm-audio";
		inmusic,cpu = <0xa9>;
		inmusic,codec = <0xaa>;
	};

	sound-codec {
		compatible = "inmusic,acvm-audio-codec";
		#sound-dai-cells = <0x00>;
		clocks = <0x07 0x71>;
		enable-gpios = <0x18 0x01 0x00>;
		mute-gpios = <0x18 0x02 0x00>;
		reset-gpios = <0x18 0x00 0x01>;
