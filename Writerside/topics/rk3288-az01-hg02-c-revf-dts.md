...
/ {
	#address-cells = <0x02>;
	#size-cells = <0x02>;
	compatible = "inmusic,hg02\0inmusic,az01\0rockchip,rk3288-c\0rockchip,rk3288";
	interrupt-parent = <0x01>;
	inmusic,product-code = "HG02";
	inmusic,panel-rotation = <0x10e>;
	model = "HeadRush GigBoard";
	...
	pinctrl {
		...
		i2s0 {
			...
			i2s0-bus {
				rockchip,pins = <0x06 0x00 0x01 0x92 0x06 0x01 0x01 0x92 0x06 0x02 0x01 0x92 0x06 0x03 0x01 0x92 0x06 0x04 0x01 0x92 0x06 0x05 0x01 0x92 0x06 0x06 0x01 0x92 0x06 0x07 0x01 0x92 0x06 0x08 0x01 0x93>;
				phandle = <0x6e>;
			};
		};
		...
		gpios {
			...
			main-out-pad-enable {
				rockchip,pins = <0x05 0x0a 0x00 0x8f>;
				phandle = <0x8a>;
			};

			fx-in-pad-enable {
				rockchip,pins = <0x05 0x0b 0x00 0x8f>;
				phandle = <0x8b>;
			};

			external-amp-t {
				rockchip,pins = <0x02 0x04 0x00 0x8f>;
				phandle = <0x8c>;
			};

			external-amp-r {
				rockchip,pins = <0x02 0x03 0x00 0x8f>;
				phandle = <0x8d>;
			};
		};
	...
	sound {
		compatible = "inmusic,hg02-audio";
		inmusic,cpu = <0xa5>;
		inmusic,codec = <0xa6>;
	};

	sound-codec {
		compatible = "inmusic,hg02-audio-codec";
		#sound-dai-cells = <0x00>;
		clocks = <0x07 0x71>;
		enable-gpios = <0x7c 0x01 0x00>;
		mute-gpios = <0x7c 0x02 0x00>;
		reset-gpios = <0x7c 0x00 0x01>;
