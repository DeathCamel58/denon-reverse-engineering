...
/ {
	#address-cells = <0x02>;
	#size-cells = <0x02>;
	compatible = "inmusic,hg03\0inmusic,az01\0rockchip,rk3288-c\0rockchip,rk3288";
	interrupt-parent = <0x01>;
	inmusic,product-code = "HG03";
	inmusic,panel-rotation = <0x10e>;
	model = "Headrush Looper Pedal";
	...
	i2c@ff140000 {
		...
		usb5537@2d {
			...
			smsc,config-file = [43 46 47 42 14 40 10 06 40 08 04 40 18 14 40 18 22 40 00 03 40 00 03 40 00 03 40 00 03 40 00 03 40 00 03 40 00 03 40 10 06 40 08 04 40 00 03 40 00 03 40 00 03 40 00 03 40 18 14 40 18 22 40 80 03 30 00 63 07 17 10 30 13 08 0f 30 16 00 10 48 00 65 00 61 00 64 00 72 00 75 00 73 00 68 00 30 54 00 1e 4c 00 6f 00 6f 00 70 00 65 00 72 00 42 00 6f 00 61 00 72 00 64 00 20 00 48 00 75 00 62 00 3c 00 03 3c 04 03 3c 08 03 3c 0c 03 3c 10 03 3c 14 03 3c 18 03 50 48 63 07 17 60 50 4e 02 03 50 18 12 50 f4 12 50 1c 20 51 34 20 50 f6 00 10 48 00 65 00 61 00 64 00 72 00 75 00 73 00 68 00 51 36 00 1e 4c 00 6f 00 6f 00 70 00 65 00 72 00 42 00 6f 00 61 00 72 00 64 00 20 00 48 00 75 00 62 00 52 43 20];
			phandle = <0x9d>;
		};
	};
	...
	vop@ff930000 {
		...
		reg = <0x00 0xff930000 0x00 0x19c>;
	...
	vop@ff940000 {
		compatible = "rockchip,rk3288-vop";
		reg = <0x00 0xff940000 0x00 0x19c>;
	...
	pinctrl {
		...
		gpio0@ff750000 {
			...
			gpio-line-names = "PMU_SLEEP\0DDRIO_PWROFF\0DDRIO_RETEN\0EFUSE_PWR\0PMIC_INT\0PWR_KEY\0\0\0\0\0PWR_HOLD\0LED_STATE2\0\0SATA_PWR_EN\0\0I2C0_SDA_PMU\0I2C0_SCL_PMU\0\0USB_INT";
			phandle = <0x59>;
		};
		...
		sound-codec {
			...
			codec-clksel {
				rockchip,pins = <0x06 0x0b 0x00 0x8c 0x06 0x08 0x00 0x8c>;
			};
	...
	sound {
		compatible = "inmusic,hg03-audio";
		inmusic,cpu = <0xa8>;
		inmusic,codec = <0xa9>;
	};

	sound-codec {
		compatible = "inmusic,hg03-audio-codec";
		#sound-dai-cells = <0x00>;
		clocks = <0x07 0x71>;
