...
/ {
	#address-cells = <0x02>;
	#size-cells = <0x02>;
	compatible = "inmusic,acv5\0inmusic,az01\0rockchip,rk3288-c\0rockchip,rk3288";
	interrupt-parent = <0x01>;
	inmusic,product-code = "ACV5";
	inmusic,panel-rotation = <0x5a>;
	model = "InMusic MPC ACV5";
	...
	i2c@ff140000 {
		...
		usb5537@2d {
			...
			smsc,config-file = [43 46 47 42 14 40 10 06 40 08 04 40 18 26 40 18 16 40 00 03 40 00 03 40 00 03 40 00 03 40 00 03 40 00 03 40 00 03 40 10 06 40 08 04 40 00 03 40 00 03 40 00 03 40 00 03 40 18 26 40 18 16 40 80 03 30 00 e8 09 3a 50 30 13 11 09 30 16 00 22 41 00 6b 00 61 00 69 00 20 00 50 00 72 00 6f 00 66 00 65 00 73 00 73 00 69 00 6f 00 6e 00 61 00 6c 00 30 54 00 12 4d 00 50 00 43 00 20 00 58 00 20 00 48 00 75 00 62 00 3c 00 03 3c 04 03 3c 08 03 3c 0c 03 3c 10 03 3c 14 03 3c 18 03 50 48 e8 09 3a 60 50 4e 02 03 50 18 24 50 f4 24 50 1c 14 51 34 14 50 f6 00 22 41 00 6b 00 61 00 69 00 20 00 50 00 72 00 6f 00 66 00 65 00 73 00 73 00 69 00 6f 00 6e 00 61 00 6c 00 51 36 00 12 4d 00 50 00 43 00 20 00 58 00 20 00 48 00 75 00 62 00 52 43 20];
