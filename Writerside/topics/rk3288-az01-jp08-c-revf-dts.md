...
/ {
	#address-cells = <0x02>;
	#size-cells = <0x02>;
	compatible = "inmusic,jp08\0inmusic,az01\0rockchip,rk3288-c\0rockchip,rk3288";
		...
		state-internal {
			...
			fragment@1 {
				...
				__overlay__ {
					...
					pinctrl-0 = <0x35 0xb4>;
					status = "okay";
					smsc,config-file = [43 46 47 42 15 40 10 06 40 08 04 40 18 14 40 18 26 40 00 03 40 00 03 40 00 03 40 00 03 40 00 03 40 00 03 40 00 03 40 80 03 40 10 06 40 08 04 40 00 03 40 00 03 40 00 03 40 00 03 40 18 14 40 18 26 40 80 03 30 00 e4 15 0a e0 30 13 08 11 30 16 00 10 44 00 65 00 6e 00 6f 00 6e 00 20 00 44 00 4a 00 30 54 00 22 53 00 43 00 35 00 30 00 30 00 30 00 4d 00 20 00 50 00 52 00 49 00 4d 00 45 00 20 00 48 00 75 00 62 00 3c 00 03 3c 04 03 3c 08 03 3c 0c 03 3c 10 03 3c 14 03 3c 18 03 30 fa 01 50 48 e4 15 0a f0 50 4e 02 03 50 18 12 50 f4 12 50 1c 24 51 34 24 50 f6 00 10 44 00 65 00 6e 00 6f 00 6e 00 20 00 44 00 4a 00 51 36 00 22 53 00 43 00 35 00 30 00 30 00 30 00 4d 00 20 00 50 00 52 00 49 00 4d 00 45 00 20 00 48 00 75 00 62 00 52 43 20];
				};
			};
	...
	sound {
		compatible = "inmusic,jp08-audio\0inmusic,jp07-audio";
	...
	sound-codec {
		compatible = "inmusic,jp08-audio-codec\0inmusic,jp07-audio-codec";
		#sound-dai-cells = <0x00>;
		clocks = <0x07 0x71>;
