...
/ {
	#address-cells = <0x02>;
	#size-cells = <0x02>;
	compatible = "inmusic,acva2\0inmusic,az05\0rockchip,rk3288";
	interrupt-parent = <0x01>;
	model = "Akai Professional MPC One+";
	inmusic,product-code = "ACVA2";
	...
	pinctrl {
		...
		hdmi {
			...
			hdmi-cec-c0 {
				rockchip,pins = <0x07 0x10 0x02 0x87>;
			};

			hdmi-cec-c7 {
				rockchip,pins = <0x07 0x17 0x04 0x87>;
			};

			hdmi-ddc {
				rockchip,pins = <0x07 0x13 0x02 0x87 0x07 0x14 0x02 0x87>;
			};

			hdmi-ddc-unwedge {
				rockchip,pins = <0x07 0x13 0x00 0x88 0x07 0x14 0x02 0x87>;
			};
		};
		...
		suspend {
			...
			global-pwroff {
				rockchip,pins = <0x00 0x00 0x01 0x87>;
			};

			ddrio-pwroff {
				rockchip,pins = <0x00 0x01 0x01 0x87>;
			};

			ddr0-retention {
				rockchip,pins = <0x00 0x02 0x01 0x89>;
			};

			ddr1-retention {
				rockchip,pins = <0x00 0x03 0x01 0x89>;
			};
		};
		...
		edp {
			...
			edp-hpd {
				rockchip,pins = <0x07 0x0b 0x02 0x8a>;
			};
		};
		...
		i2c0 {
			...
			i2c0-xfer {
				rockchip,pins = <0x00 0x0f 0x01 0x87 0x00 0x10 0x01 0x87>;
				phandle = <0x54>;
			};
		};
		...
		i2c1 {
			...
			i2c1-xfer {
				rockchip,pins = <0x08 0x04 0x01 0x87 0x08 0x05 0x01 0x87>;
				phandle = <0x30>;
			};
		};
		...
		i2c2 {
			...
			i2c2-xfer {
				rockchip,pins = <0x06 0x09 0x01 0x87 0x06 0x0a 0x01 0x87>;
				phandle = <0x57>;
			};
		};
		...
		i2c3 {
			...
			i2c3-xfer {
				rockchip,pins = <0x02 0x10 0x01 0x87 0x02 0x11 0x01 0x87>;
				phandle = <0x33>;
			};
		};
		...
		i2c4 {
			...
			i2c4-xfer {
				rockchip,pins = <0x07 0x11 0x01 0x87 0x07 0x12 0x01 0x87>;
				phandle = <0x34>;
			};
		};
		...
		i2c5 {
			...
			i2c5-xfer {
				rockchip,pins = <0x07 0x13 0x01 0x87 0x07 0x14 0x01 0x87>;
				phandle = <0x37>;
			};
		};
		...
		i2s0 {
			...
			i2s0-bus {
				rockchip,pins = <0x06 0x00 0x01 0x87 0x06 0x01 0x01 0x87 0x06 0x02 0x01 0x87 0x06 0x03 0x01 0x87 0x06 0x04 0x01 0x87 0x06 0x05 0x01 0x87 0x06 0x06 0x01 0x87 0x06 0x07 0x01 0x87>;
				phandle = <0x6c>;
			};
		};
		...
		lcdc {
			...
			lcdc-ctl {
				rockchip,pins = <0x01 0x18 0x01 0x87 0x01 0x19 0x01 0x87 0x01 0x1a 0x01 0x87 0x01 0x1b 0x01 0x87>;
				phandle = <0x7c>;
			};
		};
		...
		sdmmc {
			...
			sdmmc-clk {
				rockchip,pins = <0x06 0x14 0x01 0x87>;
				phandle = <0x0f>;
			};

			sdmmc-cmd {
				rockchip,pins = <0x06 0x15 0x01 0x89>;
				phandle = <0x10>;
			};

			sdmmc-cd {
				rockchip,pins = <0x06 0x16 0x01 0x89>;
			};

			sdmmc-bus1 {
				rockchip,pins = <0x06 0x10 0x01 0x89>;
			};

			sdmmc-bus4 {
				rockchip,pins = <0x06 0x10 0x01 0x89 0x06 0x11 0x01 0x89 0x06 0x12 0x01 0x89 0x06 0x13 0x01 0x89>;
				phandle = <0x11>;
			};

			sdmmc-cd-gpio {
				rockchip,pins = <0x06 0x16 0x00 0x89>;
				phandle = <0x12>;
			};

			sdmmc-pwr {
				rockchip,pins = <0x07 0x0b 0x00 0x87>;
				phandle = <0x95>;
			};

			sdmmc-wp-gpio {
				rockchip,pins = <0x07 0x0c 0x00 0x89>;
				phandle = <0x13>;
			};
		};
		...
		sdio0 {
			...
			sdio0-bus4 {
				rockchip,pins = <0x04 0x14 0x01 0x89 0x04 0x15 0x01 0x89 0x04 0x16 0x01 0x89 0x04 0x17 0x01 0x89>;
				phandle = <0x18>;
			};

			sdio0-cmd {
				rockchip,pins = <0x04 0x18 0x01 0x89>;
				phandle = <0x19>;
			};

			sdio0-clk {
				rockchip,pins = <0x04 0x19 0x01 0x87>;
				phandle = <0x1a>;
			};

			sdio0-cd {
				rockchip,pins = <0x04 0x1a 0x01 0x89>;
			};

			sdio0-wp {
				rockchip,pins = <0x04 0x1b 0x01 0x89>;
			};

			sdio0-pwr {
				rockchip,pins = <0x04 0x1c 0x01 0x89>;
			};

			sdio0-bkpwr {
				rockchip,pins = <0x04 0x1d 0x01 0x89>;
			};

			sdio0-int {
				rockchip,pins = <0x04 0x1e 0x01 0x89>;
				phandle = <0x1b>;
			};
		};
		...
		sdio1 {
			...
			sdio1-bus1 {
				rockchip,pins = <0x03 0x18 0x04 0x89>;
			};

			sdio1-bus4 {
				rockchip,pins = <0x03 0x18 0x04 0x89 0x03 0x19 0x04 0x89 0x03 0x1a 0x04 0x89 0x03 0x1b 0x04 0x89>;
			};

			sdio1-cd {
				rockchip,pins = <0x03 0x1c 0x04 0x89>;
			};

			sdio1-wp {
				rockchip,pins = <0x03 0x1d 0x04 0x89>;
			};

			sdio1-bkpwr {
				rockchip,pins = <0x03 0x1e 0x04 0x89>;
			};

			sdio1-int {
				rockchip,pins = <0x03 0x1f 0x04 0x89>;
			};

			sdio1-cmd {
				rockchip,pins = <0x04 0x06 0x04 0x89>;
			};

			sdio1-clk {
				rockchip,pins = <0x04 0x07 0x04 0x87>;
			};

			sdio1-pwr {
				rockchip,pins = <0x04 0x09 0x04 0x89>;
			};
		};
		...
		emmc {
			...
			emmc-clk {
				rockchip,pins = <0x03 0x12 0x02 0x87>;
				phandle = <0x1f>;
			};

			emmc-cmd {
				rockchip,pins = <0x03 0x10 0x02 0x89>;
				phandle = <0x20>;
			};

			emmc-pwr {
				rockchip,pins = <0x03 0x09 0x02 0x89>;
			};

			emmc-bus1 {
				rockchip,pins = <0x03 0x00 0x02 0x89>;
			};

			emmc-bus4 {
				rockchip,pins = <0x03 0x00 0x02 0x89 0x03 0x01 0x02 0x89 0x03 0x02 0x02 0x89 0x03 0x03 0x02 0x89>;
			};

			emmc-bus8 {
				rockchip,pins = <0x03 0x00 0x02 0x89 0x03 0x01 0x02 0x89 0x03 0x02 0x02 0x89 0x03 0x03 0x02 0x89 0x03 0x04 0x02 0x89 0x03 0x05 0x02 0x89 0x03 0x06 0x02 0x89 0x03 0x07 0x02 0x89>;
				phandle = <0x21>;
			};

			emmc-reset {
				rockchip,pins = <0x03 0x09 0x00 0x87>;
				phandle = <0x8e>;
			};
		};
		...
		spi0 {
			...
			spi0-clk {
				rockchip,pins = <0x05 0x0c 0x01 0x89>;
				phandle = <0x24>;
			};

			spi0-cs0 {
				rockchip,pins = <0x05 0x0d 0x01 0x89>;
				phandle = <0x27>;
			};

			spi0-tx {
				rockchip,pins = <0x05 0x0e 0x01 0x89>;
				phandle = <0x25>;
			};

			spi0-rx {
				rockchip,pins = <0x05 0x0f 0x01 0x89>;
				phandle = <0x26>;
			};

			spi0-cs1 {
				rockchip,pins = <0x05 0x10 0x01 0x89>;
			};
		};
		...
		spi1 {
			...
			spi1-clk {
				rockchip,pins = <0x07 0x0c 0x02 0x89>;
				phandle = <0x28>;
			};

			spi1-cs0 {
				rockchip,pins = <0x07 0x0d 0x02 0x89>;
				phandle = <0x2b>;
			};

			spi1-rx {
				rockchip,pins = <0x07 0x0e 0x02 0x89>;
				phandle = <0x2a>;
			};

			spi1-tx {
				rockchip,pins = <0x07 0x0f 0x02 0x89>;
				phandle = <0x29>;
			};
		};
		...
		spi2 {
			...
			spi2-cs1 {
				rockchip,pins = <0x08 0x03 0x01 0x89>;
			};

			spi2-clk {
				rockchip,pins = <0x08 0x06 0x01 0x89>;
				phandle = <0x2c>;
			};

			spi2-cs0 {
				rockchip,pins = <0x08 0x07 0x01 0x89>;
				phandle = <0x2f>;
			};

			spi2-rx {
				rockchip,pins = <0x08 0x08 0x01 0x89>;
				phandle = <0x2e>;
			};

			spi2-tx {
				rockchip,pins = <0x08 0x09 0x01 0x89>;
				phandle = <0x2d>;
			};
		};
		...
		uart0 {
			...
			uart0-xfer {
				rockchip,pins = <0x04 0x10 0x01 0x89 0x04 0x11 0x01 0x87>;
				phandle = <0x38>;
			};
			...
			uart0-rts {
				rockchip,pins = <0x04 0x13 0x01 0x87>;
				phandle = <0x3a>;
			};
		};
		...
		uart1 {
			...
			uart1-xfer {
				rockchip,pins = <0x05 0x08 0x01 0x89 0x05 0x09 0x01 0x87>;
				phandle = <0x40>;
			};

			uart1-cts {
				rockchip,pins = <0x05 0x0a 0x01 0x89>;
				phandle = <0x41>;
			};

			uart1-rts {
				rockchip,pins = <0x05 0x0b 0x01 0x87>;
				phandle = <0x42>;
			};
		};
		...
		uart2 {
			...
			uart2-xfer {
				rockchip,pins = <0x07 0x16 0x01 0x89 0x07 0x17 0x01 0x87>;
				phandle = <0x43>;
			};
		};
		...
		uart3 {
			...
			uart3-xfer {
				rockchip,pins = <0x07 0x07 0x01 0x89 0x07 0x08 0x01 0x87>;
				phandle = <0x44>;
			};

			uart3-cts {
				rockchip,pins = <0x07 0x09 0x01 0x89>;
			};

			uart3-rts {
				rockchip,pins = <0x07 0x0a 0x01 0x87>;
			};
		};
		...
		uart4 {
			...
			uart4-xfer {
				rockchip,pins = <0x05 0x0f 0x03 0x89 0x05 0x0e 0x03 0x87>;
				phandle = <0x45>;
			};

			uart4-cts {
				rockchip,pins = <0x05 0x0c 0x03 0x89>;
			};

			uart4-rts {
				rockchip,pins = <0x05 0x0d 0x03 0x87>;
			};
		};
		...
		tsadc {
			...
			otp-pin {
				rockchip,pins = <0x00 0x0a 0x00 0x87>;
				phandle = <0x47>;
			};

			otp-out {
				rockchip,pins = <0x00 0x0a 0x01 0x87>;
				phandle = <0x48>;
			};
		};
		...
		pwm0 {
			...
			pwm0-pin {
				rockchip,pins = <0x07 0x00 0x01 0x87>;
				phandle = <0x58>;
			};
		};
		...
		pwm1 {
			...
			pwm1-pin {
				rockchip,pins = <0x07 0x01 0x01 0x87>;
				phandle = <0x59>;
			};
		};
		...
		pwm2 {
			...
			pwm2-pin {
				rockchip,pins = <0x07 0x16 0x03 0x87>;
				phandle = <0x5a>;
			};
		};
		...
		pwm3 {
			...
			pwm3-pin {
				rockchip,pins = <0x07 0x17 0x03 0x87>;
				phandle = <0x5b>;
			};
		};
		...
		gmac {
			...
			rgmii-pins {
				rockchip,pins = <0x03 0x1e 0x03 0x87 0x03 0x1f 0x03 0x87 0x03 0x1a 0x03 0x87 0x03 0x1b 0x03 0x87 0x03 0x1c 0x03 0x8b 0x03 0x1d 0x03 0x8b 0x03 0x18 0x03 0x8b 0x03 0x19 0x03 0x8b 0x04 0x00 0x03 0x87 0x04 0x05 0x03 0x87 0x04 0x06 0x03 0x87 0x04 0x09 0x03 0x8b 0x04 0x04 0x03 0x8b 0x04 0x01 0x03 0x87 0x04 0x03 0x03 0x87>;
				phandle = <0x4d>;
			};

			rmii-pins {
				rockchip,pins = <0x03 0x1e 0x03 0x87 0x03 0x1f 0x03 0x87 0x03 0x1c 0x03 0x87 0x03 0x1d 0x03 0x87 0x04 0x00 0x03 0x87 0x04 0x05 0x03 0x87 0x04 0x04 0x03 0x87 0x04 0x01 0x03 0x87 0x04 0x02 0x03 0x87 0x04 0x03 0x03 0x87>;
			};

			phy-int {
				rockchip,pins = <0x03 0x0f 0x00 0x89>;
				phandle = <0x4e>;
			};

			phy-rst {
				rockchip,pins = <0x04 0x08 0x00 0x8c>;
				phandle = <0x4f>;
			};
		};
		...
		spdif {
			...
			spdif-tx {
				rockchip,pins = <0x06 0x0b 0x01 0x87>;
				phandle = <0x6b>;
			};
		};
		...
		amp {
			...
			amp-fault {
				rockchip,pins = <0x07 0x14 0x00 0x87>;
			};

			amp-pdn {
				rockchip,pins = <0x07 0x13 0x00 0x8b>;
			};
		};
		...
		az05 {
			...
			az05-pcb-rev {
				rockchip,pins = <0x00 0x04 0x00 0x89 0x00 0x07 0x00 0x89 0x00 0x08 0x00 0x89 0x00 0x09 0x00 0x89>;
				phandle = <0x86>;
			};
		};
		...
		bluetooth {
			...
			bt-wake {
				rockchip,pins = <0x04 0x1a 0x00 0x87>;
				phandle = <0x3d>;
			};

			bt-reg-on {
				rockchip,pins = <0x04 0x1d 0x00 0x87>;
				phandle = <0x3c>;
			};

			bt-host-wake {
				rockchip,pins = <0x04 0x1f 0x00 0x89>;
				phandle = <0x3e>;
			};
		};
		...
		buttons {
			...
			pwr-key-l {
				rockchip,pins = <0x00 0x05 0x00 0x89>;
				phandle = <0x8f>;
			};
		};
		...
		leds {
			...
			led1 {
				rockchip,pins = <0x07 0x0f 0x00 0x87>;
				phandle = <0x90>;
			};
		};
		...
		mipi-panel {
			...
			mipi-reset {
				rockchip,pins = <0x07 0x03 0x00 0x87>;
				phandle = <0x78>;
			};

			bl-en {
				rockchip,pins = <0x07 0x02 0x00 0x87>;
				phandle = <0x93>;
			};
		};
		...
		rtc {
			...
			rtc-int {
				rockchip,pins = <0x00 0x06 0x00 0x89>;
				phandle = <0x32>;
			};
		};
		...
		sdio {
			...
			wifi-enable {
				rockchip,pins = <0x04 0x1c 0x00 0x87>;
				phandle = <0x92>;
			};
		};
		...
		sound-codec {
			...
			an-power-en {
				rockchip,pins = <0x02 0x01 0x00 0x87>;
				phandle = <0x9b>;
			};

			codec-clksel {
				rockchip,pins = <0x06 0x08 0x00 0x87 0x06 0x0b 0x00 0x87>;
			};

			codec-reset {
				rockchip,pins = <0x02 0x00 0x00 0x87>;
				phandle = <0x9a>;
			};

			mute {
				rockchip,pins = <0x02 0x02 0x00 0x87>;
				phandle = <0x99>;
			};
		};
		...
		touch {
			...
			touch-int {
				rockchip,pins = <0x07 0x06 0x00 0x89>;
				phandle = <0x35>;
			};

			touch-rst {
				rockchip,pins = <0x07 0x05 0x00 0x87>;
				phandle = <0x36>;
			};
		};
