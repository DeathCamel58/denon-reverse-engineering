...
/ {
	#address-cells = <0x02>;
	#size-cells = <0x02>;
	compatible = "inmusic,acvm\0inmusic,az05\0rockchip,rk3288";
	...
	i2c@ff160000 {
		...
		ili2116@41 {
			...
			interrupts = <0x06 0x02>;
			irq-gpios = <0x0e 0x06 0x00>;
			reset-gpios = <0x0e 0x05 0x00>;
		};
	...
	serial@ff180000 {
		...
		bluetooth {
			...
			device-wakeup-gpios = <0x3e 0x1a 0x00>;
			shutdown-gpios = <0x3e 0x1d 0x00>;
		};
	};
	...
	thermal-zones {
		...
		reserve-thermal {
			...
			thermal-sensors = <0x45 0x00>;
		};

		cpu-thermal {
			polling-delay-passive = <0x64>;
			polling-delay = <0x1388>;
			thermal-sensors = <0x45 0x01>;
	...
	power-management@ff730000 {
		...
		power-controller {
			...
			power-domain@9 {
				...
				pm_qos = <0x5b 0x5c 0x5d 0x5e 0x5f 0x60 0x61 0x62 0x63>;
	...
	pinctrl {
		...
		i2s0 {
			...
			i2s0-bus {
				rockchip,pins = <0x06 0x00 0x01 0x8a 0x06 0x01 0x01 0x8a 0x06 0x02 0x01 0x8a 0x06 0x03 0x01 0x8a 0x06 0x04 0x01 0x8a 0x06 0x05 0x01 0x8a 0x06 0x06 0x01 0x8a 0x06 0x07 0x01 0x8a 0x06 0x08 0x01 0x8b>;
				phandle = <0x6b>;
			};
		};
		...
		sdmmc {
			...
			sdmmc-cd-gpio {
				rockchip,pins = <0x07 0x14 0x00 0x88>;
				phandle = <0x12>;
			};
		...
		gmac {
			...
			rgmii-pins {
				rockchip,pins = <0x03 0x1e 0x03 0x86 0x03 0x1f 0x03 0x86 0x03 0x1a 0x03 0x86 0x03 0x1b 0x03 0x86 0x03 0x1c 0x03 0x8c 0x03 0x1d 0x03 0x8c 0x03 0x18 0x03 0x8c 0x03 0x19 0x03 0x8c 0x04 0x00 0x03 0x86 0x04 0x05 0x03 0x86 0x04 0x06 0x03 0x86 0x04 0x09 0x03 0x8c 0x04 0x04 0x03 0x8c 0x04 0x01 0x03 0x86 0x04 0x03 0x03 0x86>;
				phandle = <0x4c>;
			};
			...
			phy-rst {
				rockchip,pins = <0x04 0x08 0x00 0x8d>;
				phandle = <0x4e>;
			};
		};
		...
		amp {
			...
			amp-pdn {
				rockchip,pins = <0x07 0x13 0x00 0x8c>;
			};
		};
		...
		az05 {
			...
			az05-pcb-rev {
				rockchip,pins = <0x00 0x04 0x00 0x88 0x00 0x07 0x00 0x88 0x00 0x08 0x00 0x88 0x00 0x09 0x00 0x88>;
				phandle = <0x85>;
			};
		};
		...
		sata {
			...
			sata-pwr {
				rockchip,pins = <0x07 0x0e 0x00 0x86>;
				phandle = <0x9d>;
			};

			sata-reset {
				rockchip,pins = <0x07 0x13 0x00 0x87>;
				phandle = <0x9e>;
			};
		};
	};
	...
	sound-codec {
		...
		#sound-dai-cells = <0x00>;
		clocks = <0x07 0x71>;
		enable-gpios = <0x99 0x01 0x00>;
		mute-gpios = <0x99 0x02 0x00>;
		reset-gpios = <0x99 0x00 0x01>;
