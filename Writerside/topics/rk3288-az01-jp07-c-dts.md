...
/ {
	#address-cells = <0x02>;
	#size-cells = <0x02>;
	compatible = "inmusic,jp07\0inmusic,az01\0rockchip,rk3288";
	interrupt-parent = <0x01>;
	inmusic,product-code = "JP07";
	inmusic,panel-rotation = <0x10e>;
	model = "Denon DJ SC5000 Prime";
	...
	i2c@ff140000 {
		...
		usb5537@2d {
			...
			smsc,config-file = [43 46 47 42 14 40 10 06 40 08 04 40 18 14 40 18 24 40 00 03 40 00 03 40 00 03 40 00 03 40 00 03 40 00 03 40 00 03 40 10 06 40 08 04 40 00 03 40 00 03 40 00 03 40 00 03 40 18 14 40 18 24 40 80 03 30 00 e4 15 06 e0 30 13 08 10 30 16 00 10 44 00 65 00 6e 00 6f 00 6e 00 20 00 44 00 4a 00 30 54 00 20 53 00 43 00 35 00 30 00 30 00 30 00 20 00 50 00 52 00 49 00 4d 00 45 00 20 00 48 00 75 00 62 00 3c 00 03 3c 04 03 3c 08 03 3c 0c 03 3c 10 03 3c 14 03 3c 18 03 50 48 e4 15 06 f0 50 4e 02 03 50 18 12 50 f4 12 50 1c 22 51 34 22 50 f6 00 10 44 00 65 00 6e 00 6f 00 6e 00 20 00 44 00 4a 00 51 36 00 20 53 00 43 00 35 00 30 00 30 00 30 00 20 00 50 00 52 00 49 00 4d 00 45 00 20 00 48 00 75 00 62 00 52 43 20];
			phandle = <0xa6>;
		};
	};
	...
	pinctrl {
		...
		sound-codec {
			...
			codec-master-slave {
				rockchip,pins = <0x06 0x0b 0x00 0x8d>;
				phandle = <0xac>;
			};
	...
	sound-codec {
		compatible = "inmusic,jp07-audio-codec";
		#sound-dai-cells = <0x00>;
		clocks = <0x07 0x71>;
