...
/ {
	#address-cells = <0x02>;
	#size-cells = <0x02>;
	compatible = "inmusic,acvb\0inmusic,az01\0rockchip,rk3288-c\0rockchip,rk3288";
	interrupt-parent = <0x01>;
	inmusic,product-code = "ACVB";
	inmusic,panel-rotation = <0x10e>;
	model = "Akai Professional MPC Live Mk 2";
	...
	i2c@ff140000 {
		...
		usb5537@2d {
			...
			smsc,config-file = [43 46 47 42 14 40 10 06 40 08 04 40 18 26 40 18 26 40 00 03 40 00 03 40 00 03 40 00 03 40 00 03 40 00 03 40 00 03 40 10 06 40 08 04 40 00 03 40 00 03 40 00 03 40 00 03 40 18 26 40 18 26 40 80 03 30 00 e8 09 47 50 30 13 11 11 30 16 00 22 41 00 6b 00 61 00 69 00 20 00 50 00 72 00 6f 00 66 00 65 00 73 00 73 00 69 00 6f 00 6e 00 61 00 6c 00 30 54 00 22 4d 00 50 00 43 00 20 00 4c 00 69 00 76 00 65 00 20 00 4d 00 6b 00 20 00 32 00 20 00 48 00 75 00 62 00 3c 00 03 3c 04 03 3c 08 03 3c 0c 03 3c 10 03 3c 14 03 3c 18 03 50 48 e8 09 47 60 50 4e 02 03 50 18 24 50 f4 24 50 1c 24 51 34 24 50 f6 00 22 41 00 6b 00 61 00 69 00 20 00 50 00 72 00 6f 00 66 00 65 00 73 00 73 00 69 00 6f 00 6e 00 61 00 6c 00 51 36 00 22 4d 00 50 00 43 00 20 00 4c 00 69 00 76 00 65 00 20 00 4d 00 6b 00 20 00 32 00 20 00 48 00 75 00 62 00 52 43 20];
	...
	pinctrl {
		...
		hdmi {
			...
			hdmi-cec-c0 {
				rockchip,pins = <0x07 0x10 0x02 0x8d>;
			};

			hdmi-cec-c7 {
				rockchip,pins = <0x07 0x17 0x04 0x8d>;
			};

			hdmi-ddc {
				rockchip,pins = <0x07 0x13 0x02 0x8d 0x07 0x14 0x02 0x8d>;
			};

			hdmi-ddc-unwedge {
				rockchip,pins = <0x07 0x13 0x00 0x8e 0x07 0x14 0x02 0x8d>;
			};
		};
		...
		suspend {
			...
			global-pwroff {
				rockchip,pins = <0x00 0x00 0x01 0x8d>;
			};

			ddrio-pwroff {
				rockchip,pins = <0x00 0x01 0x01 0x8d>;
			};

			ddr0-retention {
				rockchip,pins = <0x00 0x02 0x01 0x8f>;
			};
		...
		edp {
			...
			edp-hpd {
				rockchip,pins = <0x07 0x0b 0x02 0x90>;
			};
		};
		...
		i2c0 {
			...
			i2c0-xfer {
				rockchip,pins = <0x00 0x0f 0x01 0x8d 0x00 0x10 0x01 0x8d>;
				phandle = <0x56>;
			};
		};
		...
		i2c1 {
			...
			i2c1-xfer {
				rockchip,pins = <0x08 0x04 0x01 0x8d 0x08 0x05 0x01 0x8d>;
				phandle = <0x32>;
			};
		};
		...
		i2c2 {
			...
			i2c2-xfer {
				rockchip,pins = <0x06 0x09 0x01 0x8d 0x06 0x0a 0x01 0x8d>;
				phandle = <0x5b>;
			};
		};
		...
		i2c3 {
			...
			i2c3-xfer {
				rockchip,pins = <0x02 0x10 0x01 0x8d 0x02 0x11 0x01 0x8d>;
				phandle = <0x35>;
			};
		};
		...
		i2c4 {
			...
			i2c4-xfer {
				rockchip,pins = <0x07 0x11 0x01 0x8d 0x07 0x12 0x01 0x8d>;
				phandle = <0x37>;
			};
		};
		...
		i2c5 {
			...
			i2c5-xfer {
				rockchip,pins = <0x07 0x13 0x01 0x8d 0x07 0x14 0x01 0x8d>;
				phandle = <0x3a>;
			};
		};
		...
		i2s0 {
			...
			i2s0-bus {
				rockchip,pins = <0x06 0x00 0x01 0x8d 0x06 0x01 0x01 0x8d 0x06 0x02 0x01 0x8d 0x06 0x03 0x01 0x8d 0x06 0x04 0x01 0x8d 0x06 0x05 0x01 0x8d 0x06 0x06 0x01 0x8d 0x06 0x07 0x01 0x8d 0x06 0x08 0x01 0x8d>;
				phandle = <0x70>;
			};
		};
		...
		lcdc {
			...
			lcdc-ctl {
				rockchip,pins = <0x01 0x18 0x01 0x8d 0x01 0x19 0x01 0x8d 0x01 0x1a 0x01 0x8d 0x01 0x1b 0x01 0x8d>;
				phandle = <0x81>;
			};
		};
		...
		sdmmc {
			...
			sdmmc-clk {
				rockchip,pins = <0x06 0x14 0x01 0x91>;
				phandle = <0x0e>;
			};

			sdmmc-cmd {
				rockchip,pins = <0x06 0x15 0x01 0x92>;
				phandle = <0x0f>;
			};

			sdmmc-cd {
				rockchip,pins = <0x06 0x16 0x01 0x92>;
			};

			sdmmc-bus1 {
				rockchip,pins = <0x06 0x10 0x01 0x92>;
			};

			sdmmc-bus4 {
				rockchip,pins = <0x06 0x10 0x01 0x92 0x06 0x11 0x01 0x92 0x06 0x12 0x01 0x92 0x06 0x13 0x01 0x92>;
				phandle = <0x10>;
			};

			sdmmc-int-cd-gpio {
				rockchip,pins = <0x02 0x05 0x00 0x8f>;
				phandle = <0x12>;
			};

			sdmmc-ext-cd-gpio {
				rockchip,pins = <0x04 0x1b 0x00 0x8f>;
				phandle = <0x11>;
			};

			sdmmc-wp-gpio {
				rockchip,pins = <0x06 0x16 0x00 0x8f>;
				phandle = <0x13>;
			};

			sdmmc-sel-ext {
				rockchip,pins = <0x02 0x06 0x00 0x93>;
			};

			sdmmc-sel-int {
				rockchip,pins = <0x02 0x06 0x00 0x8e>;
				phandle = <0x14>;
			};

			sdmmc-pwr {
				rockchip,pins = <0x07 0x0b 0x00 0x8d>;
				phandle = <0xa1>;
			};

			sdmmc-gpios {
				rockchip,pins = <0x06 0x10 0x00 0x8e 0x06 0x11 0x00 0x8e 0x06 0x12 0x00 0x8e 0x06 0x13 0x00 0x8e 0x06 0x14 0x00 0x8e 0x06 0x15 0x00 0x8e>;
				phandle = <0x15>;
			};
		};
		...
		sdio0 {
			...
			sdio0-bus1 {
				rockchip,pins = <0x04 0x14 0x01 0x8f>;
			};

			sdio0-bus4 {
				rockchip,pins = <0x04 0x14 0x01 0x8f 0x04 0x15 0x01 0x8f 0x04 0x16 0x01 0x8f 0x04 0x17 0x01 0x8f>;
				phandle = <0x19>;
			};

			sdio0-cmd {
				rockchip,pins = <0x04 0x18 0x01 0x8f>;
				phandle = <0x1a>;
			};

			sdio0-clk {
				rockchip,pins = <0x04 0x19 0x01 0x8d>;
				phandle = <0x1b>;
			};

			sdio0-cd {
				rockchip,pins = <0x04 0x1a 0x01 0x8f>;
			};

			sdio0-wp {
				rockchip,pins = <0x04 0x1b 0x01 0x8f>;
			};

			sdio0-pwr {
				rockchip,pins = <0x04 0x1c 0x01 0x8f>;
			};

			sdio0-bkpwr {
				rockchip,pins = <0x04 0x1d 0x01 0x8f>;
			};

			sdio0-int {
				rockchip,pins = <0x04 0x1e 0x01 0x8f>;
				phandle = <0x1c>;
			};
		};
		...
		sdio1 {
			...
			sdio1-bus1 {
				rockchip,pins = <0x03 0x18 0x04 0x8f>;
			};

			sdio1-bus4 {
				rockchip,pins = <0x03 0x18 0x04 0x8f 0x03 0x19 0x04 0x8f 0x03 0x1a 0x04 0x8f 0x03 0x1b 0x04 0x8f>;
			};

			sdio1-cd {
				rockchip,pins = <0x03 0x1c 0x04 0x8f>;
			};

			sdio1-wp {
				rockchip,pins = <0x03 0x1d 0x04 0x8f>;
			};

			sdio1-bkpwr {
				rockchip,pins = <0x03 0x1e 0x04 0x8f>;
			};

			sdio1-int {
				rockchip,pins = <0x03 0x1f 0x04 0x8f>;
			};

			sdio1-cmd {
				rockchip,pins = <0x04 0x06 0x04 0x8f>;
			};

			sdio1-clk {
				rockchip,pins = <0x04 0x07 0x04 0x8d>;
			};

			sdio1-pwr {
				rockchip,pins = <0x04 0x09 0x04 0x8f>;
			};
		};
		...
		emmc {
			...
			emmc-clk {
				rockchip,pins = <0x03 0x12 0x02 0x8d>;
				phandle = <0x21>;
			};

			emmc-cmd {
				rockchip,pins = <0x03 0x10 0x02 0x8f>;
				phandle = <0x22>;
			};

			emmc-pwr {
				rockchip,pins = <0x03 0x09 0x02 0x8f>;
			};

			emmc-bus1 {
				rockchip,pins = <0x03 0x00 0x02 0x8f>;
			};

			emmc-bus4 {
				rockchip,pins = <0x03 0x00 0x02 0x8f 0x03 0x01 0x02 0x8f 0x03 0x02 0x02 0x8f 0x03 0x03 0x02 0x8f>;
			};

			emmc-bus8 {
				rockchip,pins = <0x03 0x00 0x02 0x8f 0x03 0x01 0x02 0x8f 0x03 0x02 0x02 0x8f 0x03 0x03 0x02 0x8f 0x03 0x04 0x02 0x8f 0x03 0x05 0x02 0x8f 0x03 0x06 0x02 0x8f 0x03 0x07 0x02 0x8f>;
				phandle = <0x23>;
			};

			emmc-reset {
				rockchip,pins = <0x03 0x09 0x00 0x8d>;
				phandle = <0x96>;
			};
		};
		...
		spi0 {
			...
			spi0-clk {
				rockchip,pins = <0x05 0x0c 0x01 0x8f>;
				phandle = <0x26>;
			};

			spi0-cs0 {
				rockchip,pins = <0x05 0x0d 0x01 0x8f>;
				phandle = <0x29>;
			};

			spi0-tx {
				rockchip,pins = <0x05 0x0e 0x01 0x8f>;
				phandle = <0x27>;
			};

			spi0-rx {
				rockchip,pins = <0x05 0x0f 0x01 0x8f>;
				phandle = <0x28>;
			};

			spi0-cs1 {
				rockchip,pins = <0x05 0x10 0x01 0x8f>;
			};
		};
		...
		spi1 {
			...
			spi1-clk {
				rockchip,pins = <0x07 0x0c 0x02 0x8f>;
				phandle = <0x2a>;
			};

			spi1-cs0 {
				rockchip,pins = <0x07 0x0d 0x02 0x8f>;
				phandle = <0x2d>;
			};

			spi1-rx {
				rockchip,pins = <0x07 0x0e 0x02 0x8f>;
				phandle = <0x2c>;
			};

			spi1-tx {
				rockchip,pins = <0x07 0x0f 0x02 0x8f>;
				phandle = <0x2b>;
			};
		};
		...
		spi2 {
			...
			spi2-cs1 {
				rockchip,pins = <0x08 0x03 0x01 0x8f>;
			};

			spi2-clk {
				rockchip,pins = <0x08 0x06 0x01 0x8f>;
				phandle = <0x2e>;
			};

			spi2-cs0 {
				rockchip,pins = <0x08 0x07 0x01 0x8f>;
				phandle = <0x31>;
			};

			spi2-rx {
				rockchip,pins = <0x08 0x08 0x01 0x8f>;
				phandle = <0x30>;
			};

			spi2-tx {
				rockchip,pins = <0x08 0x09 0x01 0x8f>;
				phandle = <0x2f>;
			};
		};
		...
		uart0 {
			...
			uart0-xfer {
				rockchip,pins = <0x04 0x10 0x01 0x8f 0x04 0x11 0x01 0x8d>;
				phandle = <0x3b>;
			};

			uart0-cts {
				rockchip,pins = <0x04 0x12 0x01 0x8f>;
				phandle = <0x3c>;
			};

			uart0-rts {
				rockchip,pins = <0x04 0x13 0x01 0x8d>;
				phandle = <0x3d>;
			};
		};
		...
		uart1 {
			...
			uart1-xfer {
				rockchip,pins = <0x05 0x08 0x01 0x8f 0x05 0x09 0x01 0x8d>;
				phandle = <0x42>;
			};

			uart1-cts {
				rockchip,pins = <0x05 0x0a 0x01 0x8f>;
				phandle = <0x43>;
			};

			uart1-rts {
				rockchip,pins = <0x05 0x0b 0x01 0x8d>;
				phandle = <0x44>;
			};
		};
		...
		uart2 {
			...
			uart2-xfer {
				rockchip,pins = <0x07 0x16 0x01 0x8f 0x07 0x17 0x01 0x8d>;
				phandle = <0x45>;
			};
		};
		...
		uart3 {
			...
			uart3-xfer {
				rockchip,pins = <0x07 0x07 0x01 0x8f 0x07 0x08 0x01 0x8d>;
				phandle = <0x46>;
			};

			uart3-cts {
				rockchip,pins = <0x07 0x09 0x01 0x8f>;
			};

			uart3-rts {
				rockchip,pins = <0x07 0x0a 0x01 0x8d>;
			};
		};
		...
		uart4 {
			...
			uart4-xfer {
				rockchip,pins = <0x05 0x0f 0x03 0x8f 0x05 0x0e 0x03 0x8d>;
				phandle = <0x47>;
			};

			uart4-cts {
				rockchip,pins = <0x05 0x0c 0x03 0x8f>;
			};

			uart4-rts {
				rockchip,pins = <0x05 0x0d 0x03 0x8d>;
			};
		};
		...
		tsadc {
			...
			otp-pin {
				rockchip,pins = <0x00 0x0a 0x00 0x93>;
				phandle = <0x49>;
			};

			otp-out {
				rockchip,pins = <0x00 0x0a 0x01 0x8d>;
				phandle = <0x4a>;
			};
		};
		...
		pwm0 {
			...
			pwm0-pin {
				rockchip,pins = <0x07 0x00 0x01 0x8d>;
				phandle = <0x5c>;
			};
		};
		...
		pwm1 {
			...
			pwm1-pin {
				rockchip,pins = <0x07 0x01 0x01 0x8d>;
				phandle = <0x5d>;
			};
		};
		...
		pwm2 {
			...
			pwm2-pin {
				rockchip,pins = <0x07 0x16 0x03 0x8d>;
				phandle = <0x5e>;
			};
		};
		...
		pwm3 {
			...
			pwm3-pin {
				rockchip,pins = <0x07 0x17 0x03 0x8d>;
				phandle = <0x5f>;
			};
		};
		...
		gmac {
			...
			rgmii-pins {
				rockchip,pins = <0x03 0x1e 0x03 0x8d 0x03 0x1f 0x03 0x8d 0x03 0x1a 0x03 0x8d 0x03 0x1b 0x03 0x8d 0x03 0x1c 0x03 0x94 0x03 0x1d 0x03 0x94 0x03 0x18 0x03 0x94 0x03 0x19 0x03 0x94 0x04 0x00 0x03 0x8d 0x04 0x05 0x03 0x8d 0x04 0x06 0x03 0x8d 0x04 0x09 0x03 0x94 0x04 0x04 0x03 0x94 0x04 0x01 0x03 0x8d 0x04 0x03 0x03 0x8d>;
				phandle = <0x4f>;
			};

			rmii-pins {
				rockchip,pins = <0x03 0x1e 0x03 0x8d 0x03 0x1f 0x03 0x8d 0x03 0x1c 0x03 0x8d 0x03 0x1d 0x03 0x8d 0x04 0x00 0x03 0x8d 0x04 0x05 0x03 0x8d 0x04 0x04 0x03 0x8d 0x04 0x01 0x03 0x8d 0x04 0x02 0x03 0x8d 0x04 0x03 0x03 0x8d>;
			};

			phy-int {
				rockchip,pins = <0x03 0x0f 0x00 0x8f>;
				phandle = <0x50>;
			};

			phy-rst {
				rockchip,pins = <0x04 0x08 0x00 0x93>;
				phandle = <0x51>;
			};
		};
		...
		spdif {
			...
			spdif-tx {
				rockchip,pins = <0x06 0x0b 0x01 0x8d>;
				phandle = <0x6f>;
			};
		};
		...
		az01 {
			...
			az01-pcb-rev {
				rockchip,pins = <0x02 0x08 0x00 0x8f 0x02 0x0b 0x00 0x8f 0x02 0x0d 0x00 0x8f 0x02 0x0e 0x00 0x8f>;
				phandle = <0x8c>;
			};
		};
		...
		buttons {
			...
			pwr-key-l {
				rockchip,pins = <0x00 0x05 0x00 0x8f>;
				phandle = <0x98>;
			};
		};
		...
		reboot {
			...
			pwr-off-delay {
				rockchip,pins = <0x00 0x09 0x00 0x8d>;
				phandle = <0x99>;
			};
		};
		...
		bluetooth {
			...
			bt-wake {
				rockchip,pins = <0x04 0x1a 0x00 0x8d>;
				phandle = <0x40>;
			};

			bt-reg-on {
				rockchip,pins = <0x04 0x1d 0x00 0x8d>;
				phandle = <0x3f>;
			};

			bt-host-wake {
				rockchip,pins = <0x04 0x1f 0x00 0x8f>;
				phandle = <0x41>;
			};
		};
		...
		leds {
			...
			led1 {
				rockchip,pins = <0x07 0x0f 0x00 0x8d>;
				phandle = <0x9a>;
			};

			led2 {
				rockchip,pins = <0x00 0x0b 0x00 0x8d>;
				phandle = <0x9b>;
			};
		...
		sdio {
			...
			wifi-enable {
				rockchip,pins = <0x04 0x1c 0x00 0x8d>;
				phandle = <0x9e>;
			};
		};
		...
		vcc_lcd {
			...
			lcd-en {
				rockchip,pins = <0x07 0x03 0x00 0x8d>;
			};
		};
		...
		mipi_panel {
			...
			mipi-reset {
				rockchip,pins = <0x02 0x07 0x00 0x8d>;
				phandle = <0x7c>;
			};

			lcd-cs {
				rockchip,pins = <0x07 0x04 0x00 0x8d>;
				phandle = <0x9f>;
			};
		};
		...
		pmic {
			...
			pmic-int {
				rockchip,pins = <0x00 0x04 0x00 0x8f>;
				phandle = <0x5a>;
			};
		};
		...
		sata {
			...
			sata-pwr {
				rockchip,pins = <0x00 0x0d 0x00 0x8d>;
				phandle = <0xa0>;
			};

			sata-reset {
				rockchip,pins = <0x07 0x15 0x00 0x8d>;
			};
		};
		...
		touch {
			...
			touch-int {
				rockchip,pins = <0x07 0x06 0x00 0x8f>;
				phandle = <0x38>;
			};

			touch-rst {
				rockchip,pins = <0x07 0x05 0x00 0x8d>;
				phandle = <0x39>;
			};
		};
		...
		usb_host {
			...
			host-vbus-drv {
				rockchip,pins = <0x00 0x0e 0x00 0x8d>;
				phandle = <0xa2>;
			};
		};
		...
		usb_otg {
			...
			otg-vbus-drv {
				rockchip,pins = <0x00 0x0c 0x00 0x8d>;
				phandle = <0xa3>;
			};
		};
		...
		usb-hub {
			...
			usb-reset-pin {
				rockchip,pins = <0x07 0x02 0x00 0x95>;
				phandle = <0x34>;
			};
			...
			usb-sel-int {
				rockchip,pins = <0x08 0x01 0x00 0x93>;
				phandle = <0xa6>;
			};

			usb-sel-ext {
				rockchip,pins = <0x08 0x01 0x00 0x8e>;
				phandle = <0xa8>;
			};
		};
	};
