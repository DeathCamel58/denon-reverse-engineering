...
/ {
	#address-cells = <0x02>;
	#size-cells = <0x02>;
	compatible = "inmusic,acva\0inmusic,az01\0rockchip,rk3288-c\0rockchip,rk3288";
	interrupt-parent = <0x01>;
	inmusic,product-code = "ACVA";
	inmusic,panel-rotation = <0x10e>;
	model = "Akai Professional MPC One";
	...
	dwmmc@ff0c0000 {
		...
		pinctrl-0 = <0x0e 0x0f 0x10 0x11 0x12 0x13>;
		pinctrl-1 = <0x14>;
		rockchip,default-sample-phase = <0xb4>;
		vmmc-supply = <0x15>;
		vqmmc-supply = <0x16>;
		cd-gpios = <0x17 0x16 0x01>;
		wp-gpios = <0x18 0x1b 0x00>;
	};
	...
	i2c@ff160000 {
		...
		ili2116@41 {
			...
			irq-gpios = <0x37 0x06 0x00>;
			reset-gpios = <0x37 0x05 0x00>;
		};
	...
	serial@ff180000 {
		...
		bluetooth {
			...
			device-wakeup-gpios = <0x18 0x1a 0x00>;
			shutdown-gpios = <0x18 0x1d 0x00>;
			status = "disabled";
		};
	};
	...
	power-management@ff730000 {
		...
		power-controller {
			...
			power-domain@9 {
				...
				pm_qos = <0x5e 0x5f 0x60 0x61 0x62 0x63 0x64 0x65 0x66>;
	...
	pinctrl {
		...
		gmac {
			...
			rgmii-pins {
				rockchip,pins = <0x03 0x1e 0x03 0x8c 0x03 0x1f 0x03 0x8c 0x03 0x1a 0x03 0x8c 0x03 0x1b 0x03 0x8c 0x03 0x1c 0x03 0x95 0x03 0x1d 0x03 0x95 0x03 0x18 0x03 0x95 0x03 0x19 0x03 0x95 0x04 0x00 0x03 0x8c 0x04 0x05 0x03 0x8c 0x04 0x06 0x03 0x8c 0x04 0x09 0x03 0x95 0x04 0x04 0x03 0x95 0x04 0x01 0x03 0x8c 0x04 0x03 0x03 0x8c>;
				phandle = <0x4d>;
			};
		...
		usb-host1 {
			...
			usb-hub-reset {
				rockchip,pins = <0x07 0x02 0x00 0x8c>;
				phandle = <0xa9>;
			};
		};
	};
	...
	leds {
		...
		led1 {
			gpios = <0x37 0x0f 0x01>;
			label = "az01:red:usr1";
			linux,default-trigger = "heartbeat";
		};

		led2 {
			gpios = <0x57 0x0b 0x01>;
			label = "az01:red:usr2";
	...
	sound {
		compatible = "inmusic,acva-audio";
		inmusic,cpu = <0xa4>;
		inmusic,codec = <0xa5>;
	};

	sound-codec {
		compatible = "inmusic,acva-audio-codec";
		#sound-dai-cells = <0x00>;
		clocks = <0x07 0x71>;
		enable-gpios = <0x7d 0x01 0x00>;
		mute-gpios = <0x7d 0x02 0x00>;
		reset-gpios = <0x7d 0x00 0x01>;
