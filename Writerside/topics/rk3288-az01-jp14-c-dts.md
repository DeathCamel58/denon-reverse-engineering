...
/ {
	#address-cells = <0x02>;
	#size-cells = <0x02>;
	compatible = "inmusic,jp14", "inmusic,az01", "rockchip,rk3288-c", "rockchip,rk3288";
	...
	sound {
		compatible = "inmusic,jp14-audio", "inmusic,jp07-audio";
	...
	sound-codec {
		compatible = "inmusic,jp14-audio-codec", "inmusic,jp07-audio-codec";
		#sound-dai-cells = <0x00>;
		clocks = <0x07 0x71>;
